...
class prima_nota_cassa_parser(orm.AbstractModel):
    ...
    def render_html(self, cr, uid, ids, data=None, context=None):
        ...
        if data:
            context.update({'active_model': 'sale.order', 'active_ids': data.get('form', {}).get('sale_ids', [])})
        return super(prima_nota_cassa_parser, self).render_html(cr, uid, ids, data=data, context=context)
...
#class primanotaQweb(orm.AbstractModel):
#
